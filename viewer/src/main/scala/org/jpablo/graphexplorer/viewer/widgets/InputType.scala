...
enum InputType derives CanEqual:
  ...
  case multiText(setFocus: Boolean = false)
  ...
  case currentValueWithSelector(dir: MenuDirection = MenuDirection.start, cardClass: Option[String] = None, open: Boolean = false)
  case borderPanel
