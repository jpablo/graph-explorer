...
class DifferentialSpec extends FunSuite:
  ...
  private val mustPass = List("01-minimal", "06-undirected", "07-cross")
  private val m6Corpus = List("02-attrs", "03-subgraph-cluster", "04-ports-compass", "05-strings-comments")
